...
#
# Commands:
# 	hubot report codebase users - 'These are the users I know about...'
# 	hubot report codebase activity - 'Here are the latest 20 updates.'
# 	hubot report codebase projects - 'These are all of the projects I can find.'
# 	hubot report codebase project <permalink> - 'Here is what I know about <permalink>'
# 	hubot create codebase project <Full Project Name> - 'New Project created!'
# 	hubot delete codebase project <permalink> - 'Permanently delete the project?'
# 	hubot create codebase ticket in project <permalink> with summary <summary> - 'New ticket created! Here is the link.'
# 	hubot report codebase open tickets in project <permalink> - 'Here are the open tickets I found...'
# 	hubot report codebase updates to ticket <ticket_id> in project <permalink> - 'That ticket has XX updates. Here they are...'
